...
<!-- FORK MARKER (2026-07-26 restore) [target_accept API expose, default=0.55]
     ...
     060abe4's Change 2 pilot-freeze wrap in adapt_dense_metric_ /
     adapt_three_phase_warmup_ to keep F5.b passing). -->
...
void readapt_NUTS(int n, bool reset, int max_tree_depth, double target_accept) {
    ...
    //                 target (default 0.55); sentinel <= 0 or > 1 leaves
