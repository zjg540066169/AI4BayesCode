...
Posterior conjugate update per (k, d) (Bishop PRML Sec.2.3.6 / Murphy 2007
Sec.4). Empty clusters draw from the prior -- matches Ishwaran-James 2001
Sec.3.2. Two named outputs: cfg.mu_name (length K_trunc * d, cluster-major
