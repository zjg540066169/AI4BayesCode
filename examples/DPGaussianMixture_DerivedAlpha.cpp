...
//      child(3) phi            nuts_block (REAL constraint)
//
//  LABEL SWITCHING
//  ---------------
...
RCPP_MODULE(DPGaussianMixture_DerivedAlpha_module) {
    Rcpp::class_<DPGaussianMixture_DerivedAlpha>(
        ...
        .method("readapt_NUTS",
                (void (DPGaussianMixture_DerivedAlpha::*)(int, bool, int)) &DPGaussianMixture_DerivedAlpha::readapt_NUTS,
                "Re-tune NUTS dual-averaging (3-arg backward-compat; target_accept unchanged).")
        .method("readapt_NUTS",
                (void (DPGaussianMixture_DerivedAlpha::*)(int, bool, int, double)) &DPGaussianMixture_DerivedAlpha::readapt_NUTS,
...
PYBIND11_MODULE(DPGaussianMixture_DerivedAlpha, m) {
    ...
    pybind11::class_<DPGaussianMixture_DerivedAlpha>(
        ...
        .def("readapt_NUTS", (void (DPGaussianMixture_DerivedAlpha::*)(int, bool, int, double)) &DPGaussianMixture_DerivedAlpha::readapt_NUTS,
