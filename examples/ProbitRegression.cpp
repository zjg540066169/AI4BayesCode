...
//       function(seed) new(ProbitRegression, X, y, rng_seed = seed, keep_history = TRUE),
...
//   m <- new(ProbitRegression, X, y, rng_seed = 7L, keep_history = TRUE)   # prior_sd 10
