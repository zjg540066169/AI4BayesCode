...
# ============================================================================
cat("\n=== 1. GaussianLocationScale ===\n")
ai4bayescode_source_checkout(file.path(script_dir, "GaussianLocationScale.cpp"),
...
# ============================================================================
cat("\n=== 2. BetaBernoulli ===\n")
ai4bayescode_source_checkout(file.path(script_dir, "BetaBernoulli.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir, verbose = FALSE)
...
# ============================================================================
cat("\n=== 3. DirichletSimplex ===\n")
ai4bayescode_source_checkout(file.path(script_dir, "DirichletSimplex.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir, verbose = FALSE)
...
# ============================================================================
cat("\n=== 4. DirichletSparse ===\n")
ai4bayescode_source_checkout(file.path(script_dir, "DirichletSparse.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir, verbose = FALSE)
...
# ============================================================================
cat("\n=== 5. DirichletHierarchical ===\n")
ai4bayescode_source_checkout(file.path(script_dir, "DirichletHierarchical.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir, verbose = FALSE)
...
# ============================================================================
cat("\n=== 6. ARDLasso ===\n")
ai4bayescode_source_checkout(file.path(script_dir, "ARDLasso.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir, verbose = FALSE)
