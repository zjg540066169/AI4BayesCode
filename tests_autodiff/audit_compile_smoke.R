...
ai4bayescode_source_checkout(file.path(AI4BayesCode_dir, "examples", "LogisticRegression.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir)
...
ai4bayescode_source_checkout(file.path(AI4BayesCode_dir, "examples", "ProbitRegression.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir)
...
ai4bayescode_source_checkout(file.path(AI4BayesCode_dir, "examples", "HMMGaussian2State.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir)
...
ai4bayescode_source_checkout(file.path(AI4BayesCode_dir, "examples", "GBartLogistic.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir)
...
ai4bayescode_source_checkout(file.path(AI4BayesCode_dir, "examples", "GPTimeSeries.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir)
...
ai4bayescode_source_checkout(file.path(AI4BayesCode_dir, "examples", "GPClassification.cpp"),
                    AI4BayesCode_path = AI4BayesCode_dir)
