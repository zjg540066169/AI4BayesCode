...
inline bool cansplit_bartfuns(tree::tree_p n, xinfo& xi)
{
  int L,U;
...
inline void getgoodvars_bartfuns(tree::tree_p n, xinfo& xi,  std::vector<size_t>& goodvars)
{
  goodvars.clear();
  int L,U;
...
inline double getpb(tree& t, xinfo& xi, pinfo& pi, tree::npv& goodbots)
{
...
inline double pgrow(tree::tree_p n, xinfo& xi, pinfo& pi)
{
...
inline void allsuff(tree& x, xinfo& xi, dinfo& di, tree::npv& bnv, std::vector<size_t>& nv, std::vector<double>& syv)
{
...
inline double drawnodemu_bartfuns(size_t n, double sy, double tau, double sigma, rn& gen)
{
...
inline void drmu(tree& t, xinfo& xi, dinfo& di, pinfo& pi, double sigma, rn& gen)
{
  tree::npv bnv;
...
//--------------------------------------------------
// death proposal
inline void dprop(tree& x, xinfo& xi, pinfo& pi,tree::npv& goodbots, double& PBx, tree::tree_p& nx, double& pr, rn& gen)
{
...
inline void bprop(tree& x, xinfo& xi, pinfo& pi, tree::npv& goodbots, double& PBx, tree::tree_p& nx, size_t& v, size_t& c, double& pr, std::vector<size_t>& nv, std::vector<double>& pv, bool aug, rn& gen)
{
