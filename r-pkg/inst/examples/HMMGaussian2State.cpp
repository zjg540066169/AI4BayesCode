...
RCPP_MODULE(HMMGaussian2State_module) {
    Rcpp::class_<HMMGaussian2State>("HMMGaussian2State")
        ...
        .method("predict_at",
                (AI4BayesCode::history_map (HMMGaussian2State::*)(const AI4BayesCode::state_map&) const)
                    &HMMGaussian2State::predict_at,
                "Posterior predictive y_rep given current z sequence.")
        .method("predict_at",
                (AI4BayesCode::history_map (HMMGaussian2State::*)(const AI4BayesCode::state_map&, bool) const)
                    &HMMGaussian2State::predict_at,
