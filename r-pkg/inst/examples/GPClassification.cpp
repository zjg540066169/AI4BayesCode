...
RCPP_MODULE(GPClassification_module) {
    Rcpp::class_<GPClassification>("GPClassification")
        ...
        .method("predict_at",
                (AI4BayesCode::history_map (GPClassification::*)(Rcpp::List) const)
                    &GPClassification::predict_at_r,
                "Predict at new_data. Unchanged.")
        .method("predict_at",
                (AI4BayesCode::history_map (GPClassification::*)(Rcpp::List, bool) const)
                    &GPClassification::predict_at_r,
...
PYBIND11_MODULE(GPClassification, m) {
    ...
    pybind11::class_<GPClassification>(m, "GPClassification")
        ...
        .def("predict_at",
             (AI4BayesCode::history_map (GPClassification::*)(const AI4BayesCode::state_map&, bool) const)
                 &GPClassification::predict_at,
