...
//  P-spline" pattern used by brms, mgcv, and Wood 2017 Sec.5.2.
//
//  Why an example
//  --------------
...
RCPP_MODULE(BSplineRegression_module) {
    Rcpp::class_<BSplineRegression>("BSplineRegression")
        ...
        .method("readapt_NUTS",
                (void (BSplineRegression::*)(int, bool, int)) &BSplineRegression::readapt_NUTS,
                "Re-tune NUTS dual-averaging (3-arg backward-compat; target_accept unchanged).")
        .method("readapt_NUTS",
                (void (BSplineRegression::*)(int, bool, int, double)) &BSplineRegression::readapt_NUTS,
...
PYBIND11_MODULE(BSplineRegression, m) {
    ...
    pybind11::class_<BSplineRegression>(m, "BSplineRegression")
        ...
        .def("readapt_NUTS", (void (BSplineRegression::*)(int, bool, int, double)) &BSplineRegression::readapt_NUTS,
