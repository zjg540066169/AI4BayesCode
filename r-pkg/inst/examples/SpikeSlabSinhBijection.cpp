...
//      m = v * X'y / sigma^2
//  The bijection is cross-checked against this closed form.
// ============================================================================
//
// @example:R
...
RCPP_MODULE(SpikeSlabSinhBijection_module) {
    Rcpp::class_<SpikeSlabSinhBijection>("SpikeSlabSinhBijection")
        ...
        .method("readapt_NUTS",
                (void (SpikeSlabSinhBijection::*)(int, bool, int)) &SpikeSlabSinhBijection::readapt_NUTS,
                "Re-tune NUTS dual-averaging (3-arg backward-compat; target_accept unchanged).")
        .method("readapt_NUTS",
                (void (SpikeSlabSinhBijection::*)(int, bool, int, double)) &SpikeSlabSinhBijection::readapt_NUTS,
