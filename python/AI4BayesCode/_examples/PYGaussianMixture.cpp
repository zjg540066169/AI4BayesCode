...
//      child(3) alpha          univariate_slice_sampling_block (positive, log scale)
//
...
RCPP_MODULE(PYGaussianMixture_module) {
    Rcpp::class_<PYGaussianMixture>("PYGaussianMixture")
        ...
        .method("predict_at",
                (AI4BayesCode::history_map (PYGaussianMixture::*)(const AI4BayesCode::state_map&) const)
                    &PYGaussianMixture::predict_at,
                "Posterior predictive y_rep at training X. Empty list only.")
        .method("predict_at",
                (AI4BayesCode::history_map (PYGaussianMixture::*)(const AI4BayesCode::state_map&, bool) const)
                    &PYGaussianMixture::predict_at,
